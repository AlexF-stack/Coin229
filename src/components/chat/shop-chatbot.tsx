...
export function ShopChatbot() {
  ...
  return (
    <>
      {open && (
        <div
          className="fixed bottom-24 right-4 z-50 flex w-[min(100vw-2rem,22rem)] flex-col overflow-hidden rounded-2xl border border-border bg-bg-elevated shadow-2xl md:bottom-24 md:right-8"
          role="dialog"
          aria-label="Assistant Coin229"
        >
          <header className="flex items-center justify-between bg-amber px-4 py-3 text-bg">
            <div>
              <p className="text-sm font-semibold">Assistant Coin229</p>
              <p className="text-[11px] text-bg/80">Réponse rapide</p>
            </div>
            <button
              type="button"
          ...
          >
            ...
            <button
              type="submit"
              aria-label="Envoyer"
              className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-amber text-bg"
            >
      ...
      <button
        ...
        className={cn(
          "fixed bottom-20 right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full shadow-lg transition hover:scale-105 active:scale-95 md:bottom-8 md:right-8",
          open
