...
export function LegalPage({
  ...
  return (
    <article className="mx-auto max-w-3xl space-y-6 px-4 py-8 md:px-0 md:py-12">
      ...
      <div className="prose-legal space-y-5 text-sm leading-relaxed text-fg md:text-base [&_h2]:mt-8 [&_h2]:font-display [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:text-navy [&_ul]:list-disc [&_ul]:space-y-1 [&_ul]:pl-5 [&_a]:font-medium [&_a]:text-amber">
        {children}
      </div>
    </article>
  );
